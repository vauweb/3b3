...
Изометрическая сцена баскетбола 3 на 3 на Phaser 3. Чистый HTML/CSS/JS, без сборки и без хостинга.

## Запуск

Просто откройте `index.html` двойным кликом в браузере (работает по `file://`, офлайн).
